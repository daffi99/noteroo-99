...
import { exportNoteToTxt, formatNoteAsJson } from '../utils/export'
      ...
      <div className="editor-sticky-header">
        <div className="editor-topbar">
          ...
          <div className="editor-topbar__desktop-actions">
            ...
            <button
              type="button"
              className={`editor-copy-json-btn ${isCopiedJson ? 'editor-copy-json-btn--copied' : ''}`}
              onClick={handleCopyJson}
              title="Copy note as LLM-ready JSON format to clipboard"
            >
              {isCopiedJson ? (
                <>
